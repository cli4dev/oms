...
update oms_order_info t
set t.is_refund = 0,
	t.order_status = if(t.success_face - @return_total_face = 0,90,91),
	t.fail_code=if(t.success_face - @return_total_face = 0,@fail_code,''),
	t.fail_msg=if(t.success_face - @return_total_face = 0,@fail_msg,''),
