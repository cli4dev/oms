...
i.invoice_status = decode(@status,'SUCCESS',0,'FAILED',90,i.invoice_status),
i.fail_msg = @fail_msg,
i.fail_code = @fail_code,
i.notify_status = nvl2(i.notify_url,20,99),
i.payment_status = case when @status='SUCCESS' and i.invoice_method = 1 then 20 else i.payment_status end
...
SET
invoice_status = decode(@status,'SUCCESS',0,10)
