...
type DeliveryResult struct {
	...
	DeliveryID        string  `json:"coop_order_id" form:"coop_order_id" m2s:"coop_order_id" valid:"required"`
	...
	ResultParams      string  `json:"result_params" form:"result_params" m2s:"result_params"`
}
