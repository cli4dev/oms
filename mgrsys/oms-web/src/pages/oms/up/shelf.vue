	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<el-form ref="form" :inline="true" class="form-inline pull-left">
				<el-form-item>
					<el-input clearable v-model="queryData.shelf_name" placeholder="请输入货架名称">
					</el-input>
				</el-form-item>
			
				<el-form-item>
					<el-select size="medium" v-model="queryData.channel_no" class="input-cos" filterable placeholder="请选择渠道名称">
		...
		<el-scrollbar style="height:100%">
			<el-table :data="tableData" border style="width: 100%">
				<el-table-column prop="shelf_id" label="货架编号" align="center"></el-table-column>
				...
				<el-table-column prop="delivery_overtime" align="center" label="发货超时时间" ></el-table-column>
				<el-table-column prop="return_overtime" align="center" label="退货超时时间" ></el-table-column>
...
export default {
  ...
  mounted(){
    ...
    query(){
      ...
      this.$http.get("/oms/up/shelf/query", this.queryData)
  			.then(res => {
    ...
    resetForm(formName) {
      ...
      this.$refs[formName].resetFields();
		...
		detailShow(val){
			var data = {
        getpath: "/oms/up/shelf",
        shelf_id: val.shelf_id,
      }
      this.$emit("addTab","详情"+val.shelf_id,"/oms/up/shelf.view",data);
		},
    addShow(){
      this.$refs.Add.show();
		},
