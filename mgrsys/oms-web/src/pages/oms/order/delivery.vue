  ...
  <div class="panel panel-default">
    ...
    <el-scrollbar style="height:100%">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="up_channel_no" label="上游渠道" align="center" min-width="120px">
          <template slot-scope="scope">
        ...
        <el-table-column prop="end_time" label="完成时间" align="center"></el-table-column>
        <el-table-column prop="return_msg" label="结果消息" align="center">
          <template slot-scope="scope">
            <span>{{scope.row.return_msg | EllipsisFilter(20)}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="delivery_status" label="发货状态" align="center">
          <template slot-scope="scope">
            <span
              :class="generalStatusClassFilter(scope.row.delivery_status)"
            >{{scope.row.delivery_status | EnumFilter("DeliveryStatus")}}</span>
          </template>
        </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      deliveryStatus: this.EnumUtility.Get("DeliveryStatus"),
      ...
      upPaymentStatus: this.EnumUtility.Get("UpPaymentStatus"),
      tableData: []
    };
  },
  created() {
  ...
  methods: {
    ...
    query(value) {
      ...
      this.$http
        .get("/oms/order/delivery/query", this.queryData)
        .then(res => {
