<template>
  <div>
    <el-tabs v-model="tabName" type="border-card" @tab-click="handleClick">
      <el-tab-pane label="上游退货详情" name="1">
          ...
          <table :data="item" class="table table-striped m-b-none">
            <tbody class="table-border">
              <tr>
                <td>
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right:10px">退货编号:</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="grid-content">{{item.return_id}}</div>
                  </el-col>
                  <el-col :span="6">
              ...
              <tr>
                <td>
                  ...
                  <el-col :span="6">
                    <div class="grid-content">{{item.delivery_id}}</div>
                  </el-col>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right:10px">退回佣金:</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="grid-content">{{item.return_commission_amount |AmountFilter}}</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right:10px">退回成本:</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="grid-content">{{item.return_cost_amount|AmountFilter}}</div>
                  </el-col>
                </td>
              </tr>
              <tr>
                <td>
                  ...
                  <el-col :span="6">
                    <div class="grid-content">{{item.return_face|AmountFilter}}</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right:10px">退货返回信息:</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="grid-content">{{item.return_msg}}</div>
                  </el-col>
                </td>
              </tr>
              <tr>
                <td>
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right:10px">退货数量:</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="grid-content">{{item.return_num}}</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right:10px">退回服务费:</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="grid-content">{{item.return_service_amount |AmountFilter}}</div>
                  </el-col>
                </td>
              </tr>
              <tr>
                <td>
                  ...
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right:10px">退货状态:</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="grid-content"  :class="generalStatusClassFilter(item.return_status)">{{item.return_status | EnumFilter("ReturnStatus")}}</div>
                  </el-col>
                </td>
              </tr>
              <tr>
                <td>
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right:10px">退货总面值:</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="grid-content">{{item.return_total_face |AmountFilter}}</div>
                  </el-col>
                  <el-col :span="6">
              ...
              <tr>
                <td>
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right:10px">上游渠道:</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="grid-content">{{item.up_channel_no | EnumFilter("UpChannelNo")}}</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right:10px">上游商品请求编号:</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="grid-content">{{item.up_ext_product_no}}</div>
                  </el-col>
                </td>
              </tr>
              <tr>
                <td>
                  ...
                  <el-col :span="6">
                    <div class="grid-content">{{item.up_product_id}}</div>
                  </el-col>
                  <el-col :span="6">
                  ...
                  <el-col :span="6">
                    ...
                    >{{item.up_refund_status | EnumFilter("UpRefundStatus")}}</div>
                  </el-col>
                </td>
              </tr>
              <tr>
                <td>
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right:10px">上游退货编号:</div>
                  </el-col>
                  <el-col :span="6">
                    <div class="grid-content">{{item.up_return_no}}</div>
                  </el-col>
                </td>
              </tr>
            </tbody>
...
export default {
  ...
  created() {
    ...
    this.EnumUtility.Get("ReturnStatus");
    this.EnumUtility.Get("UpChannelNo", {}, "/oms/up/channel/getdictionary");
    this.EnumUtility.Get("UpRefundStatus");
  },
  mounted() {
    this.Init();
  },
