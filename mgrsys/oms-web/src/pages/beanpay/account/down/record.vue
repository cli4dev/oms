  ...
  <div class="panel panel-default">
    ...
    <el-scrollbar style="height:100%">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <!-- <el-table-column prop="deduct_no" label="扣款编号" align="center">
          <template slot-scope="scope">
            <span>{{scope.row.deduct_no | EllipsisFilter(20)}}</span>
          </template>
        </el-table-column>-->
...
export default {
  ...
  created() {
    this.$http
      .get("/beanpay/account/info/getdowndictionary", {})
      .then(res => {
        this.accountId = res;
      })
      .catch(err => {
